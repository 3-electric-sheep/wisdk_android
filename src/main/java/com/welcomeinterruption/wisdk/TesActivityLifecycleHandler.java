...
public class TesActivityLifecycleHandler implements Application.ActivityLifecycleCallbacks {
    ...
    public TesActivityLifecycleHandler(LifecycleListener listener) {
